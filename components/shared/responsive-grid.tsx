...
const ResponsiveGrid: React.FC<ResponsiveGridProps> = ({ children }) => {
  return (
    <div className=" mb-12 flex h-full w-full max-w-1920 flex-col pt-3 md:mb-24 md:pt-4 lg:pt-6">
      <div className="grid grid-cols-1 gap-x-3 gap-y-10 md:grid-cols-3 md:gap-x-10 xl:grid-cols-4">
        {children}
      </div>
    </div>
  );
